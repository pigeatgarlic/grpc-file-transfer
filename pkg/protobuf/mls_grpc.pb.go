...
// All implementations should embed UnimplementedMLSServiceServer
// for forward compatibility
type MLSServiceServer interface {
	Upload(MLSService_UploadServer) error
}

// UnimplementedMLSServiceServer should be embedded to have forward compatible implementations.
...
var MLSService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/protobuf/mls.proto",
}
